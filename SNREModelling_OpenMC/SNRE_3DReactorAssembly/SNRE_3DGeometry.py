    ...
    def createGeometry(self):
        ...
        RH_rootUni.plot(basis='xy',
                        ...
                        colors={self.materials.FE_coolant: 'paleturquoise',
                                ...
                                self.materials.RH_lowerTieTubePlenum: 'mediumslateblue',
                                self.materials.RH_coreSupportPlate: 'darkslateblue',
                                self.materials.RH_upperTieTubePlenum: 'mediumslateblue',
                                ...
                                self.materials.RH_controlDrumActuatorZone: 'darkslategray',
                                self.materials.RH_brimShield: 'midnightblue',
        ...
        RH_rootUni.plot(basis='xz',
                        ...
                        pixels=[1000,1000])
        plt.savefig('./pics/Geometry/xz/reactorHousingAxial_xz{}.png'.format(int(self.CD_drumAngularPos)), dpi=300)
        plt.show()
        ...
        RH_rootUni.plot(basis='yz',
                        ...
                        pixels=[1000,1000])
        plt.savefig('./pics/Geometry/yz/reactorHousingAxial_yz{}.png'.format(int(self.CD_drumAngularPos)), dpi=300)
        plt.show()
