...
openmc.Materials.cross_sections = "/home/emmajstewart/openmc_data/mcnp_endfb70/cross_sections.xml"
...
SE_materials.export_to_xml('/home/emmajstewart/Dropbox/openmc_calculations/snre_calculations/core/jimmy_model/SE_materials.xml')

VE_gasStagnant = openmc.Material(name='VE_gasStagnant', temperature=300)
VE_gasStagnant.set_density('g/cm3', 1.9127E-03)
VE_gasStagnant.add_nuclide('H1', 9.9977E-01, 'wo')
VE_gasStagnant.add_nuclide('H2', 2.2980E-04, 'wo')
...
RH_materials.export_to_xml('/home/emmajstewart/Dropbox/openmc_calculations/snre_calculations/core/jimmy_model/RH_materials.xml')
...
materials = openmc.Materials([FE_fuel,
                              ...
                              RH_brimShield,
                              RH_pressureVessel])
materials.export_to_xml('/home/emmajstewart/Dropbox/openmc_calculations/snre_calculations/core/jimmy_model/')
...
FE_geom.export_to_xml('/home/emmajstewart/Dropbox/openmc_calculations/snre_calculations/core/jimmy_model/FE_geometry.xml')
...
SE_geom.export_to_xml('/home/emmajstewart/Dropbox/openmc_calculations/snre_calculations/core/jimmy_model/SE_geometry.xml')
...
VE_subassemblyVoidCell.fill = RH_berylliumReflector
VE_rootUni = openmc.Universe(cells=[VE_subassemblyVoidCell])

VE_geom=openmc.Geometry(VE_rootUni)
VE_geom.export_to_xml('/home/emmajstewart/Dropbox/openmc_calculations/snre_calculations/core/jimmy_model/VE_geometry.xml')
...
CA_geom.export_to_xml('/home/emmajstewart/Dropbox/openmc_calculations/snre_calculations/core/jimmy_model/CA_geometry.xml')
...
CD_geom.export_to_xml('/home/emmajstewart/Dropbox/openmc_calculations/snre_calculations/core/jimmy_model/CD_geometry.xml')
...
RH_gapInnerCell = openmc.Cell(cell_id=651, fill=VE_gasStagnant, region=+RH_coreOuter & -RH_gapInnerOuter & -RH_coreTopBoundaryPlane & +RH_coreBottomBoundaryPlane)
...
RH_gapMid1Cell = openmc.Cell(cell_id=653, fill=VE_gasStagnant, region=+RH_steelWrapperOuter & -RH_gapMid1Outer & -RH_coreTopBoundaryPlane & +RH_coreBottomBoundaryPlane)
...
RH_gapMid2Cell = openmc.Cell(cell_id=655, fill=VE_gasStagnant, region=+RH_berylliumBarrelOuter & -RH_gapMid2Outer & -RH_coreTopBoundaryPlane & +RH_coreBottomBoundaryPlane)
...
RH_gapOuterCell = openmc.Cell(cell_id=657, fill=VE_gasStagnant,region=+RH_berylliumReflectorOuter & -RH_gapOuterOuter & -RH_coreTopBoundaryPlane & +RH_pressureVesselBottomPlane)
...
RH_geom.export_to_xml('/home/emmajstewart/Dropbox/openmc_calculations/snre_calculations/core/jimmy_model/geometry.xml')
...
settings.export_to_xml('/home/emmajstewart/Dropbox/openmc_calculations/snre_calculations/core/jimmy_model/')
